      ...
      <div class="container px-3">
         <div class="shop-categories">
              ...
              <div class="col">
                <div class="category-card">
                  <a href="shop-grid-left-sidebar.html">
                    <img src="assets/images/gallery/categories/baby/breast-pumps.jpg" class="rounded-circle img-fluid product-img border p-2" alt="Branded breast pumps">
                  </a>
                  ...
                  <div class="d-grid mt-3">
                    <a href="shop-grid-left-sidebar.html" class="btn btn-outline-dark border border-2 rounded-5 d-flex align-items-center justify-content-center gap-2 py-2"><span>Browse Listings</span><i class="bi bi-arrow-up-right"></i></a>
                  </div>
                </div>
              </div>
              <div class="col">
                <div class="category-card">
                  <a href="shop-grid-left-sidebar.html">
                    <img src="assets/images/gallery/categories/baby/prams.jpg" class="rounded-circle img-fluid product-img border p-2" alt="Prams & Strollers">
                  </a>
                  <div class="mt-3 text-center">
              ...
              <div class="col">
                <div class="category-card">
                  <a href="shop-grid-left-sidebar.html">
                    <img src="assets/images/gallery/categories/baby/car-seats.jpg" class="rounded-circle img-fluid product-img border p-2" alt="Car Seats">
                  </a>
                  <div class="mt-3 text-center">
              ...
              <div class="col">
                <div class="category-card">
                  <a href="shop-grid-left-sidebar.html">
                    <img src="assets/images/gallery/categories/baby/nursery-furniture.jpg" class="rounded-circle img-fluid product-img border p-2" alt="Nursery Furniture">
                  </a>
                  <div class="mt-3 text-center">
              ...
              <div class="col">
                <div class="category-card">
                  <a href="shop-grid-left-sidebar.html">
                    <img src="assets/images/gallery/categories/baby/bassinets.jpg" class="rounded-circle img-fluid product-img border p-2" alt="Bassinets">
                  </a>
                  <div class="mt-3 text-center">
