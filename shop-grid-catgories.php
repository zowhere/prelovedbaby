      ...
      <div class="container px-3">
         <div class="shop-categories">
              ...
              <div class="col">
                <div class="category-card border p-3 rounded-3">
                  <a href="shop-grid-left-sidebar.html">
                    <img src="assets/images/gallery/categories/baby/breast-pumps.jpg" class="rounded-3 img-fluid product-img" alt="Branded breast pumps">
                  </a>
                  <div class="mt-3">
                  ...
                  <div class="d-grid mt-3">
                    <a href="shop-grid-left-sidebar.html" class="btn btn-dark rounded-3 d-flex align-items-center justify-content-center gap-2 py-2"><span>Browse Listings</span><i class="bi bi-arrow-up-right"></i></a>
                  </div>
                </div>
              </div>
              <div class="col">
                <div class="category-card border p-3 rounded-3">
                  <a href="shop-grid-left-sidebar.html">
                    <img src="assets/images/gallery/categories/baby/prams.jpg" class="rounded-3 img-fluid product-img" alt="Prams & Strollers">
                  </a>
                  <div class="mt-3">
              ...
              <div class="col">
                <div class="category-card border p-3 rounded-3">
                  <a href="shop-grid-left-sidebar.html">
                    <img src="assets/images/gallery/categories/baby/car-seats.jpg" class="rounded-3 img-fluid product-img" alt="Car Seats">
                  </a>
                  <div class="mt-3">
              ...
              <div class="col">
                <div class="category-card border p-3 rounded-3">
                  <a href="shop-grid-left-sidebar.html">
                    <img src="assets/images/gallery/categories/baby/nursery-furniture.jpg" class="rounded-3 img-fluid product-img" alt="Nursery Furniture">
                  </a>
                  <div class="mt-3">
              ...
              <div class="col">
                <div class="category-card border p-3 rounded-3">
                  <a href="shop-grid-left-sidebar.html">
                    <img src="assets/images/gallery/categories/baby/bassinets.jpg" class="rounded-3 img-fluid product-img" alt="Bassinets">
                  </a>
                  <div class="mt-3">
