...
$error = $_GET['error'] ?? '';
if (isLoggedIn()) {
    header('Location: ' . (can('dashboard.view') ? 'admin/index.php' : 'account-my-profile.php'));
    exit;
}
?>
           ...
           <div class="row g-4 g-lg-5 align-items-center">
             <div class="col-12 col-xl-6">
               <div class="auth-register p-4 p-sm-5 rounded-3 border">
                  ...
                  <p>Don't have an account yet? <a href="auth-register.php" class="text-decoration-underline link-body-emphasis">Sign Up</a></p>
                  <?php if ($error): ?>
                  ...
                  <form class="form-body mt-5" method="post" action="auth-actions.php">
                    ...
                    <div class="row row-cols-1 g-3">
                      ...
                      <div class="col-md-6 text-end"><a href="auth-forgot-password.php" class="text-decoration-underline link-body-emphasis">Forgot Password ?</a>
											</div>
                      <div class="col">
                        <div class="d-grid">
             ...
             <div class="col-12 col-xl-6 d-none d-xl-flex">
               <div class="auth-register-img">
                  <img src="images/gallery/auth/login.png" class="img-fluid" width="650" alt="">
               </div>
             </div> 
           </div>
        </div>
