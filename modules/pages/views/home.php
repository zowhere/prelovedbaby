...
<nav class="navbar navbar-expand-xl border-bottom py-3">
      <div class="container px-3">
            ...
            <ul class="navbar-nav mx-auto gap-0 gap-xl-2">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                  <li>
                    <a class="dropdown-item" href="shop-grid-left-sidebar.php"
                      >All Listings</a
                    >
                  </li>
                  <li>
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu submenu">
                      ...
                      <li>
                        <a class="dropdown-item" href="account-my-profile.php"
                          >My Profile</a
                        >
                      </li>
                      <li>
                        <a class="dropdown-item" href="account-addresses.php"
                      ...
                      <li>
                        <a
                          class="dropdown-item"
                          href="account-payment-methods.php"
                          >Payment Methods</a
                        >
                      </li>
</ul>
        ...
        <div class="right-links nav gap-2 d-flex align-items-center">
          ...
          ></a>
          <a class="nav-link" href="account-my-profile.php"
            ...
            <div class="swiper categories-slider">
              <div class="swiper-wrapper">
                <div class="swiper-slide">
                  <a href="shop-grid-catgories.php">
                ...
                <div class="swiper-slide">
                  <a href="shop-circular-catgories.php">
                    <div class="d-flex flex-column align-items-center gap-3">
                      <img
