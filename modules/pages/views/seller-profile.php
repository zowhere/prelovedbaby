          ...
          <div class="col-12 col-lg-4">
            <div class="seller-profile-card">
              <div class="text-center">
                <img src="images/gallery/sellers/sarah-m.jpg" class="seller-avatar seller-avatar-xl mx-auto mb-3" alt="Sarah M." width="120" height="120" loading="lazy">
                ...
                <a href="contact-us.php" class="btn btn-dark w-100 rounded-5 mb-2"><i class="bi bi-chat-dots me-2"></i>Message Sarah</a>
              </div>
              <hr>
                  ...
                  <div class="product-card product-card--listing border rounded-3 p-3 h-100">
                    <div class="d-flex flex-column gap-3">
                      <div class="position-relative product-img-wrap">
                        ...
                        <a href="product-detail.php">
                          <img src="images/gallery/products/recommended/breast-pump.png" class="product-img img-fluid rounded-3" alt="Medela Swing Breast Pump" loading="lazy" decoding="async">
                        </a>
                      </div>
                      <div>
