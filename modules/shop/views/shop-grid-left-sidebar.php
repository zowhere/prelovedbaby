          ...
          <div class="offcanvas-body p-0">
            <ul class="navbar-nav mx-auto gap-0 gap-xl-2">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                  <li><a class="dropdown-item" href="auth-register.php">Sell an Item</a></li>
                  <li>
                    <hr class="dropdown-divider">
                  </li>
                  <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu submenu">
                      ...
                      <li><a class="dropdown-item" href="account-my-profile.php">My Profile</a></li>
                      <li><a class="dropdown-item" href="account-addresses.php">Delivery Addresses</a></li>
                    ...
                    <div class="d-flex flex-column gap-3">
                      <div class="position-relative product-img-wrap">
                        ...
                        <a href="product-detail.php?id=chicco-pram">
                          <img src="images/gallery/products/recommended/chicco-pram.png" class="product-img img-fluid rounded-3" alt="Compact Baby Pram" loading="lazy" decoding="async">
                        </a>
                        ...
                        <div class="position-absolute bottom-0 start-0 end-0 m-3 product-cart">
                          <a href="product-detail.php?id=chicco-pram" class="btn btn-dark rounded-5 w-100">View Listing</a>
                        </div>
                      </div>
                      <div>
                    ...
                    <div class="d-flex flex-column gap-3">
                      <div class="position-relative product-img-wrap">
                        ...
                        <a href="product-detail.php?id=breast-pump">
                          <img src="images/gallery/products/recommended/breast-pump.png" class="product-img img-fluid rounded-3" alt="Electric Breast Pump" loading="lazy" decoding="async">
                        </a>
                        <div class="position-absolute top-0 end-0 m-3 product-actions">
                          <div class="d-flex flex-column gap-2">
                            <a href="javascript:;" class="btn btn-action"><i class="bi bi-heart"></i></a>
                        ...
                        <div class="position-absolute bottom-0 start-0 end-0 m-3 product-cart">
                          <a href="product-detail.php?id=breast-pump" class="btn btn-dark rounded-5 w-100">View Listing</a>
                        </div>
                      </div>
                      <div>
                  ...
                  <div class="product-card product-card--listing border rounded-3 p-3">
                    <div class="d-flex flex-column gap-3">
                      <div class="position-relative product-img-wrap">
                        ...
                        <a href="product-detail.php?id=baby-cot">
                          <img src="images/gallery/products/recommended/baby-cot.png" class="product-img img-fluid rounded-3" alt="Wooden Baby Cot" loading="lazy" decoding="async">
                        </a>
                        <div class="position-absolute top-0 end-0 m-3 product-actions">
                          <div class="d-flex flex-column gap-2">
                            <a href="javascript:;" class="btn btn-action"><i class="bi bi-heart"></i></a>
                        ...
                        <div class="position-absolute bottom-0 start-0 end-0 m-3 product-cart">
                          <a href="product-detail.php?id=baby-cot" class="btn btn-dark rounded-5 w-100">View Listing</a>
                        </div>
                      </div>
                      <div>
                    ...
                    <div class="d-flex flex-column gap-3">
                      <div class="position-relative product-img-wrap">
                        ...
                        <a href="product-detail.php?id=car-seat">
                          <img src="images/gallery/products/recommended/car-seat.jpg" class="product-img img-fluid rounded-3" alt="Group 0+ Car Seat" loading="lazy" decoding="async">
                        </a>
                        <div class="position-absolute top-0 end-0 m-3 product-actions">
                          <div class="d-flex flex-column gap-2">
                            <a href="javascript:;" class="btn btn-action"><i class="bi bi-heart"></i></a>
                        ...
                        <div class="position-absolute bottom-0 start-0 end-0 m-3 product-cart">
                          <a href="product-detail.php?id=car-seat" class="btn btn-dark rounded-5 w-100">View Listing</a>
                        </div>
                      </div>
                      <div>
                ...
                <div class="col">
                  <div class="product-card product-card--listing border rounded-3 p-3">
                    <div class="d-flex flex-column gap-3">
                      <div class="position-relative product-img-wrap">
                        <span class="listing-condition-badge position-absolute top-0 start-0 m-3">Good</span>
                        <a href="product-detail.php?id=high-chair">
                          <img src="images/gallery/products/recommended/high-chair.png" class="product-img img-fluid rounded-3" alt="Convertible High Chair" loading="lazy" decoding="async">
                        </a>
                        <div class="position-absolute top-0 end-0 m-3 product-actions">
                          <div class="d-flex flex-column gap-2">
                            <a href="javascript:;" class="btn btn-action"><i class="bi bi-heart"></i></a>
                        ...
                        <div class="position-absolute bottom-0 start-0 end-0 m-3 product-cart">
                          <a href="product-detail.php?id=high-chair" class="btn btn-dark rounded-5 w-100">View Listing</a>
                        </div>
                      </div>
                      <div>
                        <p class="listing-brand mb-1">Chicco</p>
