	  ...
	  <h2 class="d-none">Product Details</h2>
        <nav>
          <ol class="breadcrumb mb-0 gap-2">
            ...
            <li class="breadcrumb-item"><a href="shop-grid-left-sidebar.php" class="breadcrumb-link">Prams &amp; Strollers</a></li>
            <li><i class="bi bi-chevron-right"></i></li>
           ...
           <div class="col-12 col-lg-6">
              <div class="product-images">
                <div class="swiper product-images-swiper">
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <img src="images/gallery/products/recommended/chicco-pram.png" class="rounded-3 product-detail-img" alt="Compact Baby Pram front view">
                    </div>
                    <div class="swiper-slide">
                      <img src="images/gallery/products/recommended/chicco-pram.png" class="rounded-3 product-detail-img" alt="Compact Baby Pram side view">
                    </div>
                    <div class="swiper-slide">
                      <img src="images/gallery/products/recommended/chicco-pram.png" class="rounded-3 product-detail-img" alt="Compact Baby Pram folded">
                    </div>
                    <div class="swiper-slide">
                      <img src="images/gallery/products/recommended/chicco-pram.png" class="rounded-3 product-detail-img" alt="Compact Baby Pram detail">
                    </div>
                  </div>
                </div>
                <div class="swiper product-images-swiper-thumbnail mt-3">
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <img src="images/gallery/products/recommended/chicco-pram.png" class="rounded-3" alt="Compact Baby Pram front view">
                    </div>
                    <div class="swiper-slide">
                      <img src="images/gallery/products/recommended/chicco-pram.png" class="rounded-3" alt="Compact Baby Pram side view">
                    </div>
                    <div class="swiper-slide">
                      <img src="images/gallery/products/recommended/chicco-pram.png" class="rounded-3" alt="Compact Baby Pram folded">
                    </div>
                    <div class="swiper-slide">
                      <img src="images/gallery/products/recommended/chicco-pram.png" class="rounded-3" alt="Compact Baby Pram detail">
                    </div>
                  </div>
                </div>
              </div>
