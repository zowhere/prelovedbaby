                  ...
                  <div class="col-12 col-lg-8">
                    ...
                    <div class="d-flex flex-column flex-xl-row align-items-xl-center gap-3 mt-4">
                      <div class="product-cart">
                        <a href="product-detail.html" class="btn btn-dark rounded-5 px-5 w-300">View Listing</a>
                      </div>
...
<a href="javascript:;" class="btn btn-outline-dark border btn-action"><i class="bi bi-funnel"></i></a>
              ...
              <div class="product-card-list">
                <div class="row g-4">
                  <div class="col-12 col-lg-4">
                    <a href="product-detail.html">
                      <img src="assets/images/gallery/tabular-product/07.png" class="product-img img-fluid rounded-3" alt="Ergonomic Baby Carrier">
                    </a>
                  </div>
                  <div class="col-12 col-lg-8">
              ...
              <div class="product-card-list">
                <div class="row g-4">
                  ...
                  <div class="col-12 col-lg-8">
                    ...
                    <a href="seller-profile.html" class="listing-seller d-inline-flex align-items-center gap-2 text-decoration-none mt-2">
