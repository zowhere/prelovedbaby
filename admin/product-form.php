        ...
        <form action="product-actions.php" method="post">
          ...
          <div class="row g-3">
            ...
            <div class="col-12">
              ...
              <input type="text" class="form-control border-2" id="image" name="image" value="<?= htmlspecialchars($product['image'] ?? '') ?>" placeholder="assets/images/gallery/products/recommended/chicco-pram.png">
            </div>
            <div class="col-12">
