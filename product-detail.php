	  ...
	  <h2 class="d-none">Product Details</h2>
        <nav>
          <ol class="breadcrumb mb-0 gap-2">
            ...
            <li class="breadcrumb-item"><a href="shop-grid-left-sidebar.html" class="breadcrumb-link">Prams &amp; Strollers</a></li>
            <li><i class="bi bi-chevron-right"></i></li>
           ...
           <div class="col-12 col-lg-6">
              <div class="product-images">
                <div class="swiper product-images-swiper">
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <img src="assets/images/gallery/products/recommended/chicco-pram.png" class="rounded-3 product-detail-img" alt="Compact Baby Pram front view">
                    </div>
                    <div class="swiper-slide">
                      <img src="assets/images/gallery/products/recommended/chicco-pram.png" class="rounded-3 product-detail-img" alt="Compact Baby Pram side view">
                    </div>
                    <div class="swiper-slide">
                      <img src="assets/images/gallery/products/recommended/chicco-pram.png" class="rounded-3 product-detail-img" alt="Compact Baby Pram folded">
                    </div>
                    <div class="swiper-slide">
                      <img src="assets/images/gallery/products/recommended/chicco-pram.png" class="rounded-3 product-detail-img" alt="Compact Baby Pram detail">
                    </div>
                  </div>
                </div>
                <div class="swiper product-images-swiper-thumbnail mt-3">
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <img src="assets/images/gallery/products/recommended/chicco-pram.png" class="rounded-3" alt="Compact Baby Pram front view">
                    </div>
                    <div class="swiper-slide">
                      <img src="assets/images/gallery/products/recommended/chicco-pram.png" class="rounded-3" alt="Compact Baby Pram side view">
                    </div>
                    <div class="swiper-slide">
                      <img src="assets/images/gallery/products/recommended/chicco-pram.png" class="rounded-3" alt="Compact Baby Pram folded">
                    </div>
                    <div class="swiper-slide">
                      <img src="assets/images/gallery/products/recommended/chicco-pram.png" class="rounded-3" alt="Compact Baby Pram detail">
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <div class="product-cart-buttons d-grid d-md-flex align-items-center gap-3 mt-4">
                    ...
                    <?php else: ?>
                     <form action="cart-actions.php" method="post" class="flex-fill m-0">
                       ...
                       <input type="hidden" name="redirect" value="product-detail.php?id=<?php echo urlencode($productId); ?>">
        ...
        <div class="tabular-product-details mt-5">
          ...
          <div class="tab-content border p-4 rounded-3">
            <div class="tab-pane fade show active" id="description">
              ...
              <?php include __DIR__ . '/includes/product-description.php'; ?>
               </div>
              ...
              <div class="swiper-slide">
                <div class="product-card product-card--listing border rounded-3 p-3">
                  <div class="d-flex flex-column gap-3">
                    <div class="position-relative product-img-wrap">
                      <a href="product-detail.html">
                        <img src="assets/images/gallery/products/recommended/baby-cot.png" class="product-img img-fluid rounded-3" alt="Wooden Baby Cot">
                      </a>
                      <div class="position-absolute bottom-0 start-0 end-0 m-3 product-cart">
                        <a href="javascript:;" class="btn btn-dark rounded-5 w-100">Add to cart</a>
                      </div>
              ...
              <div class="swiper-slide">
                <div class="product-card product-card--listing border rounded-3 p-3">
                  <div class="d-flex flex-column gap-3">
                    <div class="position-relative product-img-wrap">
                      <a href="product-detail.html">
                        <img src="assets/images/gallery/products/recommended/car-seat.jpg" class="product-img img-fluid rounded-3" alt="Group 0+ Car Seat">
                      </a>
                      <div class="position-absolute bottom-0 start-0 end-0 m-3 product-cart">
                        <a href="javascript:;" class="btn btn-dark rounded-5 w-100">Add to cart</a>
                      </div>
              ...
              <div class="swiper-slide">
                <div class="product-card product-card--listing border rounded-3 p-3">
                  <div class="d-flex flex-column gap-3">
                    <div class="position-relative product-img-wrap">
                      <a href="product-detail.html">
                        <img src="assets/images/gallery/products/recommended/high-chair.png" class="product-img img-fluid rounded-3" alt="Convertible High Chair">
                      </a>
                      <div class="position-absolute bottom-0 start-0 end-0 m-3 product-cart">
                        <a href="javascript:;" class="btn btn-dark rounded-5 w-100">Add to cart</a>
                      </div>
              ...
              <div class="swiper-slide">
                <div class="product-card product-card--listing border rounded-3 p-3">
                  <div class="d-flex flex-column gap-3">
                    <div class="position-relative product-img-wrap">
                      <a href="product-detail.html">
                        <img src="assets/images/gallery/products/recommended/bassinet.png" class="product-img img-fluid rounded-3" alt="Co-Sleeper Bassinet">
                      </a>
                      <div class="position-absolute bottom-0 start-0 end-0 m-3 product-cart">
                        <a href="javascript:;" class="btn btn-dark rounded-5 w-100">Add to cart</a>
                      </div>
                      ...
                      <div>
                        ...
                        <a href="seller-profile.html" class="listing-seller d-flex align-items-center gap-2 text-decoration-none">
                          <img src="assets/images/gallery/sellers/nadia-p.jpg" class="seller-avatar" alt="Nadia P." width="36" height="36" loading="lazy">
                          <span class="flex-grow-1">
