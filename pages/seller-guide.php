...
<head>
  ...
  <title>Seller Guide · PreLoved Baby</title>
      ...
      <div class="container px-3 d-flex flex-column align-items-center justify-content-center">
        ...
        <nav>
          <ol class="breadcrumb mb-0 gap-2">
            ...
            <li class="breadcrumb-item breadcrumb-active">Seller Guide</li>
          </ol>
        </nav>
      </div>
    </section>
      ...
      <div class="container px-3">
        <div class="row justify-content-center">
          <div class="col-12 col-lg-8">
            <p class="text-para mb-4">Selling on PreLoved Baby is straightforward. List gear your family has outgrown and reach buyers across South Africa.</p>
            <ol class="text-para mb-4 ps-3">
              <li class="mb-2"><strong>Create a seller account</strong> — register with your name, email and password.</li>
              <li class="mb-2"><strong>Add your listing</strong> — upload clear photos, set a fair price and describe the condition honestly.</li>
              <li class="mb-2"><strong>Respond to buyers</strong> — answer questions and confirm availability promptly.</li>
              <li class="mb-2"><strong>Arrange handover</strong> — agree collection or courier once payment is confirmed.</li>
            </ol>
            <a href="<?= htmlspecialchars($siteBase) ?>pages/auth/register-seller.php" class="btn btn-dark px-4 me-2">Register as a Seller</a>
