      ...
      <div class="container px-3">
        <div class="row g-4 g-lg-5">
          <div class="col-12 col-lg-6">
            <div class="about-img">
              <img src="<?= htmlspecialchars($siteBase) ?>images/gallery/pages/vision.jpg" class="img-fluid rounded-4 about-page-img" alt="Preloved baby essentials">
            </div>
          </div>
          <div class="col-12 col-lg-6">
    ...
    <section class="py-5">
      <div class="container px-3">
        <div class="row g-4 g-lg-5 align-items-center">
          <div class="col-12 col-lg-6">
            <img src="<?= htmlspecialchars($siteBase) ?>images/gallery/team/01.png" class="img-fluid rounded-4 about-page-img" alt="Zoe Bulle">
          </div>
          <div class="col-12 col-lg-6">
        ...
        <div class="row row-cols-2 row-cols-sm-3 row-cols-lg-4 g-4 justify-content-center">
          <div class="col">
            <div class="brand-logo p-4 border rounded-3 h-100 d-flex align-items-center justify-content-center">
              <img src="<?= htmlspecialchars($siteBase) ?>images/gallery/brands/chelino-baby.png" class="img-fluid brand-logo-img" alt="ChelinoBaby">
            </div>
          </div>
          <div class="col">
            <div class="brand-logo p-4 border rounded-3 h-100 d-flex align-items-center justify-content-center">
