           ...
           <div class="row g-4 g-lg-5 align-items-center">
                    ...
                    <div class="row row-cols-1 g-3">
                      ...
                      <div class="col">
                        <div class="d-grid gap-3">
                          ...
                          <a href="auth-login.html" class="btn btn-outline-dark border btn-lg px-4 rounded-3"><span class="fs-6">Back to login</span></a>
                        </div>
                      </div>
                    </div>
                  </div>
             ...
             <div class="col-12 col-xl-6 d-none d-xl-flex">
               <div class="auth-register-img">
                  <img src="assets/images/gallery/auth/forgot-password.png" class="img-fluid" width="450" alt="">
               </div>
             </div> 
           </div>
        </div>
