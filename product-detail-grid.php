            ...
            <div class="product-images-grid">
              <div class="product-zoom-images">
                <div class="row row-cols-2 g-4">
                  <div class="col">
                    <div class="img-thumb-container overflow-hidden position-relative" data-fancybox="gallery" data-src="assets/images/gallery/product-images/01.png">
                      <img src="assets/images/gallery/product-images/01.png" class="img-fluid rounded-3" alt="">
                    </div>
                  </div>
                  <div class="col">
                    <div class="img-thumb-container overflow-hidden position-relative" data-fancybox="gallery" data-src="assets/images/gallery/product-images/02.png">
                      <img src="assets/images/gallery/product-images/02.png" class="img-fluid rounded-3" alt="">
                    </div>
                  </div>
                  <div class="col">
                    <div class="img-thumb-container overflow-hidden position-relative" data-fancybox="gallery" data-src="assets/images/gallery/product-images/03.png">
                      <img src="assets/images/gallery/product-images/03.png" class="img-fluid rounded-3" alt="">
                    </div>
                  </div>
                  <div class="col">
                    <div class="img-thumb-container overflow-hidden position-relative" data-fancybox="gallery" data-src="assets/images/gallery/product-images/04.png">
                      <img src="assets/images/gallery/product-images/04.png" class="img-fluid rounded-3" alt="">
                    </div>
                  </div>
                  <div class="col">
                    <div class="img-thumb-container overflow-hidden position-relative" data-fancybox="gallery" data-src="assets/images/gallery/product-images/05.png">
                      <img src="assets/images/gallery/product-images/05.png" class="img-fluid rounded-3" alt="">
                    </div>
                  </div>
                  <div class="col">
                    <div class="img-thumb-container overflow-hidden position-relative" data-fancybox="gallery" data-src="assets/images/gallery/product-images/02.png">
