...
$error = $_GET['error'] ?? '';
if (isLoggedIn()) {
    header('Location: account-my-profile.html');
    exit;
}
?>
           ...
           <div class="row g-4 g-lg-5 align-items-center">
             <div class="col-12 col-xl-6">
               <div class="auth-register p-4 p-sm-5 rounded-3 border">
                  ...
                  <p>I already have an account <a href="auth-login.php" class="text-decoration-underline link-body-emphasis">Sign In</a></p>
                  <?php if ($error): ?>
                  <div class="alert alert-danger mt-4 mb-0"><?= htmlspecialchars($error) ?></div>
                  <?php endif; ?>
                  <form class="form-body mt-5" method="post" action="auth-actions.php">
                    <input type="hidden" name="action" value="register">
                    <div class="row row-cols-1 g-3">
                       <div class="col">
                          <label for="FullName" class="form-label">Full name</label>
                          <input type="text" class="form-control form-control-lg border-2" id="FullName" name="name" required autocomplete="name">
                       </div>
                       <div class="col">
                       ...
                       <div class="col">
                        ...
                        <div class="input-group" id="show_hide_password">
													<input type="password" class="form-control form-control-lg border-end-0" id="inputChoosePassword" name="password" placeholder="At least 8 characters" required autocomplete="new-password">
                      ...
                      <div class="col">
                        ...
                        <div class="input-group" id="show_hide_password_confirm">
													<input type="password" class="form-control form-control-lg border-end-0" id="ConfirmPassword" name="password_confirm" placeholder="Confirm password" required autocomplete="new-password">
                          <a href="javascript:;" class="input-group-text bg-transparent"><i class="bi bi-eye-slash-fill"></i></a>
												</div>
                      </div>
                      <div class="col">
                      ...
                      <div class="col">
                        <div class="d-grid">
                          <button type="submit" class="btn btn-dark btn-lg px-4 rounded-3"><span class="fs-6">Create an account</span></button>
                        </div>
                      </div>
                    </div>
                  </form>
             ...
             <div class="col-12 col-xl-6 d-none d-xl-flex">
               <div class="auth-register-img">
                  <img src="assets/images/gallery/auth/register.png" class="img-fluid" width="650" alt="">
               </div>
             </div> 
           </div>
        </div>
