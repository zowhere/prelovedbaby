           ...
           <div class="row g-4 g-lg-5 align-items-center">
               ...
               <div class="auth-register p-4 p-sm-5 rounded-3 border">
                  ...
                  <form class="form-body mt-5" method="post" action="auth-actions.php">
                    ...
                    <div class="row row-cols-1 g-3">
                      ...
                      <div class="col-md-6 text-end"><a href="auth-forgot-password.html" class="text-decoration-underline link-body-emphasis">Forgot Password ?</a>
											</div>
                      <div class="col">
                        <div class="d-grid">
             ...
             <div class="col-12 col-xl-6 d-none d-xl-flex">
               <div class="auth-register-img">
                  <img src="assets/images/gallery/auth/login.png" class="img-fluid" width="650" alt="">
               </div>
             </div> 
           </div>
        </div>
